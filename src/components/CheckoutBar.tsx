...
const CheckoutBar = () => {
  return (
    <div className="flex gap-2 w-full overflow-x-hidden">
        ...
        <div className=" flex  ">
            <div className="  bg-gray-100 shadow-2xl border-black shadow-black  2xl:w-[450px] w-[350px]">
              <div className="bg-zinc-800 2xl:h-[230px] h-[130px]"></div>
              <div className="flex justify-between items-center py-2 px-3  gap-3 bg-white rounded-2xl m-3">
              ...
              <div className="flex  px-4 py-3 justify-between items-end ">
                ...
                <Button className="bg-black flex gap-1 rounded-full">
              ...
              <div className=" px-4 py-2">
                ...
                <Link to={"CheckOutPage"}>
                  <Button className="bg-black w-full rounded-full mt-4 py-6 ">
